...
class PieceView(grid: GridPane, movable: Boolean, piece: Piece, pieceSpritePath: String, attemptMove: (Int, Int) -> Unit) : ImageView(Image(FileInputStream("$pieceSpritePath${piece.side.sideName}_${piece.pieceName}.png"))) {
